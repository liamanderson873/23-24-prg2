public class CentroComercial {
    public static void main(String[] args) {
        ...
        for (int tiempo = 1; tiempo < minutosEnUnDia; tiempo++) {
            ...
            if (items[0] > 0) {
                items[0]--;
                if (items[0] == 0) { libre[0] = true; }
            }
            if (items[1] > 0) {
                items[1]--;
                if (items[1] == 0) { libre[1] = true; }
            }
            if (items[2] > 0) {
                items[2]--;
                if (items[2] == 0) { libre[2] = true; }
            }
            if (items[3] > 0) {
                items[3]--;
                if (items[3] == 0) { libre[3] = true; }
            }
            if (items[4] > 0) {
                items[4]--;
                if (items[4] == 0) { libre[4] = true; }
            }
            ...
            System.out.print(" Caja1:[" + items[0] + "] | Caja2:[" + items[1] + "] | Caja3:[" + items[2] + "] | Caja4:[" + items[3] + "]");
            if (items[4] > 0 || activa) {
            ...
            if (cola >= 15) { activa = true; } else { activa = false; }
        }
        ...
        int total = 0;
        for (int i = 0; i < caja.length; i++) { total += caja[i]; }
